...
public class Radio implements ModInitializer {
    ...
    public static final Item RADIO_BLOCK_ITEM = new EnergyBlockItem(RADIO_BLOCK, new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE), RADIO_ENERGY_CAPACITY, RADIO_ENERGY_USAGE);
    public static final Item SPEAKER_BLOCK_ITEM = new EnergyBlockItem(SPEAKER_BLOCK, new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE), SPEAKER_ENERGY_CAPACITY, SPEAKER_ENERGY_USAGE);

    private final RemoteControllerItem REMOTE_CONTROLLER_ITEM = new RemoteControllerItem(new FabricItemSettings().maxCount(REMOTE_CONTROLLER_STACK_SIZE));
    private final Item ELECTRONIC_CIRCUIT_ITEM = new Item(new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE));
    private final Item BATTERY_ITEM = new Item(new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE));
    private final Item SMALL_BATTERY_ITEM = new Item(new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE));
    private final Item ANTENNA_ITEM = new Item(new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE));
    private final Item SMALL_MEMBRANE_ITEM = new Item(new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE));
    private final Item MEMBRANE_ITEM = new Item(new FabricItemSettings().maxCount(DEFAULT_STACK_SIZE));
