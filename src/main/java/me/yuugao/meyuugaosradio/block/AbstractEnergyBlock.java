...
public abstract class AbstractEnergyBlock extends BlockWithEntity {
    ...
    public void dropBlock(World world, BlockPos pos) {
        ...
        if (be instanceof AbstractEnergyBlockEntity abstractEnergyBlockEntity) {
            ...
            nbt.putLong("Energy", abstractEnergyBlockEntity.getAmount());
            nbt.putLong("Capacity", abstractEnergyBlockEntity.getCapacity());
            nbt.putLong("Usage", abstractEnergyBlockEntity.getUsage());
            nbt.putFloat("Volume", abstractEnergyBlockEntity.getVolume());
