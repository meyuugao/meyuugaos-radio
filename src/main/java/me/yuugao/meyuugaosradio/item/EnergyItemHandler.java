...
public class EnergyItemHandler {
    ...
    public MutableText createEnergyText(long energy, long capacity) {
        return new LiteralText(StringUtils.EMPTY)
                .append(new TranslatableText("tooltip.energy").formatted(Formatting.GRAY))
                .append(new LiteralText(String.format(" %d/%d E", energy, capacity)).formatted(Formatting.GOLD));
    }

    public MutableText createUsageText(long usage) {
        return new LiteralText(StringUtils.EMPTY)
                .append(new TranslatableText("tooltip.usage").formatted(Formatting.GRAY))
                .append(new TranslatableText(String.format(" %d E/", usage)))
                .append(new TranslatableText("tooltip.usage.ticksuffix")).formatted(Formatting.GOLD);
    }
}