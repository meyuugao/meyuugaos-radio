...
public class Constants {
    ...
    public static final Identifier TECHREBORN_WRENCH_ID = new Identifier("techreborn", "wrench");
    public static final Identifier MEYUUGAOSRADIO_REMOTE_CONTROLLER_ID = new Identifier("meyuugaosradio", "remote_controller");
}