...
public class RadioGuiScreen extends BaseGuiScreen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
        ...
        RenderSystem.setShaderTexture(0, RADIO_MAIN_TEXT_FIELD_TEXTURE);
        drawTexture(matrixStack, x + TEXT_FIELD_X, y + TEXT_FIELD_Y, 0, 0,
                TEXT_FIELD_WIDTH, TEXT_FIELD_HEIGHT, TEXT_FIELD_WIDTH, TEXT_FIELD_HEIGHT);
        ...
        drawTextWithShadow(matrixStack, textRenderer, new LiteralText(streamUrl), textX - textOffset, textY, 0xFFFFFF);
        ...
        if (textFieldFocused) {
            ...
            if (cursorVisible) {
                ...
                drawTexture(matrixStack, cursorX, textY, 0, 0,
                        TEXT_FIELD_CURSOR_WIDTH, TEXT_FIELD_CURSOR_HEIGHT, 1, 8);
            }
        }
